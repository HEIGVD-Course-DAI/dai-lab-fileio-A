...
import ch.heig.dai.lab.fileio.Sinaf19.*;

public class Main {
    // *** TODO: Change this to your own name ***
    private static final String newName = "Sinaf19";
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                // if the newFile is null all the files have been tested
                if(newFile == null)
                    break;
                ...
                String processedFileName = folder + '/' + newFile.getName() + ".processed";
