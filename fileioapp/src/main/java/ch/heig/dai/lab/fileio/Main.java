...
import ch.heig.dai.lab.fileio.AndreaGraf.*;

public class Main {
    // *** TODO: Change this to your own name ***
    private static final String newName = "Andrea Graf";
    ...
    public static void main(String[] args) {
        ...
        // Create the Transformer with the new name and words per line
        Transformer transformer = new Transformer(newName, wordsPerLine);

        // Initialize necessary components (FileExplorer, EncodingSelector, FileReaderWriter)
        ...
        while (true) {
            try {
                ...
                if (encoding != null) {
                    ...
                    System.out.println("Unrecognized file encoding: " + inputFile.getName());
                }
            } catch (Exception e) {
