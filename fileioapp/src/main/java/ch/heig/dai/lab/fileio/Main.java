...
import ch.heig.dai.lab.fileio.StefBianchet.*;

public class Main {
    private static final String newName = "Stefano Bianchet";
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                File result = new File(currentFile.getPath() + ".processed");

                Charset charset = encoding.getEncoding(currentFile);
                ...
                fileReaderWriter.writeFile(result,content, StandardCharsets.UTF_8);
