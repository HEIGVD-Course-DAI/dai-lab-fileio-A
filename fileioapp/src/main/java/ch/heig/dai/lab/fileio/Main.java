...
import ch.heig.dai.lab.fileio.borishuu.*;

public class Main {
    // *** TODO: Change this to your own name ***
    private static final String newName = "Boris Hutzli";
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                File newFile = explorer.getNewFile();
                Charset encoding = encodingSelector.getEncoding(newFile);
                String fileContent = readerWriter.readFile(newFile, encoding);
                ...
                readerWriter.writeFile(newFile, fileContent, encoding);
            } catch (Exception e) {
